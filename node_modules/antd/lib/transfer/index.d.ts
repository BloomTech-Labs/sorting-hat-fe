import * as React from 'antd/lib/transfer/node_modules/react';
import List, { TransferListProps } from 'antd/lib/transfer/list';
...
declare class Transfer extends React.Component<TransferProps, any> {
    ...
    static Operation: ({ disabled, moveToLeft, moveToRight, leftArrowText, rightArrowText, leftActive, rightActive, className, style, direction, }: import("antd/lib/transfer/operation").TransferOperationProps) => JSX.Element;
    ...
    moveTo: (direction: import("antd/lib/collapse/Collapse").ExpandIconPosition) => void;
    moveToLeft: () => void;
    moveToRight: () => void;
    onItemSelectAll: (direction: import("antd/lib/collapse/Collapse").ExpandIconPosition, selectedKeys: string[], checkAll: boolean) => void;
    ...
    handleFilter: (direction: import("antd/lib/collapse/Collapse").ExpandIconPosition, e: React.ChangeEvent<HTMLInputElement>) => void;
    handleLeftFilter: (e: React.ChangeEvent<HTMLInputElement>) => void;
    handleRightFilter: (e: React.ChangeEvent<HTMLInputElement>) => void;
    handleClear: (direction: import("antd/lib/collapse/Collapse").ExpandIconPosition) => void;
    handleLeftClear: () => void;
    handleRightClear: () => void;
    onItemSelect: (direction: import("antd/lib/collapse/Collapse").ExpandIconPosition, selectedKey: string, checked: boolean) => void;
    onLeftItemSelect: (selectedKey: string, checked: boolean) => void;
    onRightItemSelect: (selectedKey: string, checked: boolean) => void;
    handleScroll: (direction: import("antd/lib/collapse/Collapse").ExpandIconPosition, e: React.SyntheticEvent<HTMLUListElement, Event>) => void;
    ...
    handleListStyle: (listStyle: React.CSSProperties | ((style: ListStyle) => React.CSSProperties), direction: import("antd/lib/collapse/Collapse").ExpandIconPosition) => React.CSSProperties;
    separateDataSource(): {
        leftDataSource: TransferItem[];
        rightDataSource: TransferItem[];
    };
