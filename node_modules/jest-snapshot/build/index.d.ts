 ...
 */
import { Config } from 'jest-snapshot/src/node_modules/@jest/types';
import { MatcherState } from 'jest-snapshot/src/node_modules/expect';
import { SnapshotResolver as JestSnapshotResolver } from 'jest-snapshot/src/snapshot_resolver';
import SnapshotState from 'jest-snapshot/src/State';
import * as utils from 'jest-snapshot/src/utils';
...
declare const JestSnapshot: {
    ...
    addSerializer: (plugin: import("jest-snapshot/src/node_modules/pretty-format/build/types").Plugin) => void;
    buildSnapshotResolver: (config: Config.ProjectConfig) => JestSnapshotResolver;
    cleanup: (hasteFS: import("jest-snapshot/src/node_modules/jest-haste-map/build/HasteFS").default, update: Config.SnapshotUpdateState, snapshotResolver: JestSnapshotResolver, testPathIgnorePatterns?: string[] | undefined) => {
        filesRemoved: number;
        filesRemovedList: string[];
    };
    getSerializers: () => import("jest-snapshot/src/node_modules/pretty-format/build/types").Plugin[];
