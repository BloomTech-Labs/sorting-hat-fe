		...
		<div className="mr-8 ml-8 mt-32 text-xs sm:text-sm md:text-lg lg:text-2xl">
			...
			<div className="flex items-center justify-center noto-sans">
				<section className="max-w-3xl m-10 border-black noto-sans flex-column">
					<h2 className="pb-1 font-bold text-black border-b-2 lg:text-3xl ">Results</h2>
					<div>
						<p className="py-3 protoGray noto-sans mb-6">
							...
							. Take this into consideration all tracks and percentages, and remember this is just a quiz.
							Follow your heart.
						</p>
					</div>
					...
					<div>
						<h2 className="pb-1 border-b-2 fira-sans lg:lg:text-3xl">{selectedTrack.name}</h2>
						<p className="py-3 protoGray noto-sans mb-20">{selectedTrack.description}</p>
					</div>
					...
					<div className="container mt-5">
						...
						<p className="py-3 protoGray noto-sans mb-20">{selectedTrack.strengths}</p>
					</div>
					...
					<div>
						<h2 className="pb-1 mb-2 text-black border-b-2 fira-sans text-3xl">Discover Other Tracks</h2>
