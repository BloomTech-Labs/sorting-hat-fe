	...
	return (
		<>
			...
			<section className="flex flex-wrap justify-center w-1/4 pt-2 pb-2 m-auto mt-40 ">
				...
				<Link
					to="/quiz"
					className="z-10 w-full px-20 py-2 mt-4 text-center text-white bg-purple-900 border border-purple-900 rounded pointer-events-auto fira-sans hover:bg-purple-700"
				>
					Start Quiz
				</Link>
			</section>
