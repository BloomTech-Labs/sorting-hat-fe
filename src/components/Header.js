...
function Header(props) {
	...
	return (
		<nav className="flex flex-wrap items-center justify-between p-6 fira-sans">
			...
			<NavLink to="/" className="mr-6 text-2xl font-bold text-black hover:text-purple-900">
				Tech Sorting Hat
			</NavLink>
			...
			<div className="flex justify-end sm:flex-grow flex-end">
				...
				<NavLink to="/about" className="mt-auto mr-4 text-lg text-black protoGray hover:text-purple-900">
					About
				</NavLink>
			</div>
		</nav>
